            ...
            <form ng-submit="completeOrder()"
                ...
                <div class="row p-0">
                    ...
                    <div class="col-xl-6 col-sm-12 mb-4">
                        ...
                        <input value="<?php echo $khachHang['email']?>" type="text" name="email" id="email" class="form-control" ng-model="userData.email">
                    </div>

                    <div class="col-12 mb-4">
                        <label for="phone" class="form-label">Số Điện Thoại</label>
                        <input value="<?php echo $khachHang['SDT']?>" type="text" name="phone" id="phone" class="form-control" ng-model="userData.mobile">
                    </div>
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        ...
                        <select ng-model="selectedDistrict"
                            ng-options="district.Name for district in selectedProvince.Districts" class="form-control">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <input value="<?php echo $khachHang['diaChiGiaoHang']?>" type="text" name="addressDetail" id="addressDetail" class="form-control"
                ...
                <div class="shadow-sm px-3 rounded-3 border d-flex flex-column gap-3 pt-2 pb-4">
                    ...
                    <div class="custom-dash d-flex flex-column gap-2 pb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h5 class="mb-0 text-danger fw-bold">{{ totalPrice | currency : "" : 0 }}đ</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container shadow-sm border my-5">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $index = 0; foreach($dataAllChiTietSanPham as $value){
                        ++$index;
                    ?>
                <tr ng-repeat="item in cart" class="position-relative">
                    ...
                    <td>
                        <?php echo number_format($value['giaSanPham'] * $value['soLuongHangMua'])?>đ
                    </td>
                </tr>
                <?php }?>
            </tbody>
