   ...
   <div class="wrapper-user-information">
      <form action="#" method="POST" class="update form" id="update">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="updatePhone" class="form-control" value="<?= $user['SDT']?>" onchange="checking_Phone_Number()">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="updateEmail" class="form-control" value="<?= $user['email']?>" onchange="checking_Email_Address()">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="updateAddress" class="form-control" value="<?= $user['diaChiGiaoHang']?>" onchange="checking_Address()">
