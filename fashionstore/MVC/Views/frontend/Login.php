      <form class="login-form" action="#" id="login-form" method="POST">
         ...
         <div class="form-input">
            ...
            <input placeholder="Username" type="text" id="text_username_login" name="text_username_login" onchange="checking_Username()">
            <div id="empty-username-error-massage" style="display: none; color: red;" ">Tài khoản không được để trống</div>
         </div>
         <div class=" form-input">
               <label for="">Mật khẩu:</label>
               <input placeholder="Password" type="password" id="text_password_login" name="text_password_login" onchange="checking_Password()">
