<?php
    class Database {
        ...
        public $username = "root"; // Thay bằng tên người dùng cơ sở dữ liệu
        public $password = ""; // Thay bằng mật khẩu của người dùng cơ sở dữ liệu
        public $dbname = "fashionstore"; // Thay bằng tên cơ sở dữ liệu
        public $conn;
